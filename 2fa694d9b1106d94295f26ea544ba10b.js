...
function auto_tab_menu($this) {
    ...
    for (let i = 0; i < data.level.length; i++) {
        $(data.scope + " ." + data.level[i]).css({
            "padding-left": (10 * i + 10) + "px",
            "font-family": data.font,
            "font-size": data.size[i] + "px",
            "margin-bottom": data.margin[i] + "px"
        });
    }

    $this.find(".table-content").css({
    ...
    $(window).scroll(function() {
        ...
        if (scrollTop >= offsetTopHeads) {
            ...
            if (scrollTop > container_h - height) {
                $this.find(".table-content").css({
                    "position": "fixed",
                    "top": -(scrollTop - (container_h - height)) + "px",
                    "width": width + "px"
                });
            }
        } else {
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground1 = function(options) {
        var height;
        var width;
        var points = 800;
        ...
        function createSnow(snowID) {
            ...
            snow[snowID].radius -= 0.02;
            if (snow[snowID].radius <= 0) {
                snow[snowID].posX = snow[snowID].initialX;
                snow[snowID].posY = snow[snowID].initialY;
                snow[snowID].radius = 2;
                snow[snowID].opacity = 0
            }
            if (snow[snowID].opacity < snow[snowID].initialOpacity) {
                snow[snowID].opacity += 0.05
            }
        }
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground3 = function(options) {
        var scroll_count;
        var scroll_time;
        var height;
        var width;
        ...
        function createSnow(snowID) {
            ctx.beginPath();
            var grd = ctx.createLinearGradient(snow[snowID].posX - snow[snowID].radius * Math.cos(snow[snowID].gradAngle * Math.PI / 180), snow[snowID].posY - snow[snowID].radius * Math.sin(snow[snowID].gradAngle * Math.PI / 180), snow[snowID].posX + snow[snowID].radius * Math.cos(snow[snowID].gradAngle * Math.PI / 180), snow[snowID].posY + snow[snowID].radius * Math.sin(snow[snowID].gradAngle * Math.PI / 180));
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground4 = function(options) {
        var height;
        var width;
        var drops = 500;
        var length = 40;
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground5 = function(options) {
        var height;
        var width;
        var birds = 5;
        var points = 5;
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground6 = function(options) {
        var height;
        var width;
        var numberOfPoints = 200;
        var radius = 1;
        ...
        function drawStar(posX, posY) {
            ...
            ctx.beginPath();
            ctx.arc(posX, posY, radius * 0.5, 0, Math.PI * 2, true);
            ctx.closePath();
            ctx.fill();
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground7 = function(options) {
        var height;
        var width;
        var numberOfPoints = 200;
        var radius = 1;
        ...
        function setBackground() {
            ...
            for (var i = 0; i < numberOfPoints; i++) {
                ...
                d = starY[i] - (starY[i] - destStarY[i]) * timeOut / 400;
                var grd = ctx.createLinearGradient(a, b, c, d);
                grd.addColorStop(0, "rgba(" + color.r + "," + color.g + "," + color.b + ", .02)");
                grd.addColorStop(1, "rgba(" + color.r + "," + color.g + "," + color.b + ", 0)");
                ctx.strokeStyle = grd;
                ctx.moveTo(tempx, tempy);
                tempx = starX[i] - (starX[i] - destStarX[i]) * timeOut / 400;
...
(function($, window) {
    $ = jQuery;
    $.fn.flexBackground8 = function(options) {
        var height;
        var width;
        var numberOfPoints = 200;
        var radius = 1;
